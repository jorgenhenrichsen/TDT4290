# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-10-20 07:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PendingGroup',
            fields=[
                ('group_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='resultregistration.Group')),
                ('sent', models.BooleanField(default=False, verbose_name='Sendt til godkjenning')),
                ('approved', models.CharField(choices=[('Godkjent', 'approved'), ('Ikke godkjent', 'denied'), ('Ikke sendt', 'not_sent'), ('Til godkjenning', 'pending')], default=resultregistration.enums.Status('Ikke godkjent'), max_length=20, verbose_name='Status')),
            ],
            bases=('resultregistration.group',),
        ),
        migrations.CreateModel(
            name='PendingResult',
            fields=[
                ('result_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='resultregistration.Result')),
                ('sent', models.BooleanField(default=False, verbose_name='Sendt til godkjenning')),
                ('approved', models.CharField(choices=[('Godkjent', 'approved'), ('Ikke godkjent', 'denied'), ('Ikke sendt', 'not_sent'), ('Til godkjenning', 'pending')], default=resultregistration.enums.Status('Ikke godkjent'), max_length=20, verbose_name='Status')),
            ],
            bases=('resultregistration.result',),
        ),
        migrations.CreateModel(
            name='Staff',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='best_clean_and_jerk', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='best_clean_and_jerk', to='resultregistration.MoveAttempt'),
        ),
        migrations.AddField(
            model_name='result',
            name='best_snatch',
            field=models.ForeignKey(blank=True, db_column='best_snatch', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='best_snatch', to='resultregistration.MoveAttempt'),
        ),
        migrations.AddField(
            model_name='result',
            name='group',
        ...
        migrations.AddField(
            model_name='group',
            name='competition',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='resultregistration.Competition'),
        ),
        migrations.AddField(
            model_name='result',
            name='lifter',
